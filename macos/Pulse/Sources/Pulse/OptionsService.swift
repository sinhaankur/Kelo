...
enum OptionsService {
    ...
    static func occSymbol(for call: CallPosition) -> String {
    ...
    static func fetchChain(underlying: String) async -> [String: OptionQuote] {
    ...
    static func fetchAll(underlyings: [String]) async -> [String: OptionQuote] {
